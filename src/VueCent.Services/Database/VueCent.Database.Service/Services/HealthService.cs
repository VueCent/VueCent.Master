...
// ***********************************************************************
// <copyright file="HealthService.cs" company="VueCent.Database.Service">
...
using VueCent.Database.DTO;

namespace VueCent.Database.Service.Services
{
    /// <summary>
    /// Class HealthService.
    /// Implements the <see cref="VueCent.Database.DTO.Health.HealthBase" />
    /// </summary>
    /// <seealso cref="VueCent.Database.DTO.Health.HealthBase" />
